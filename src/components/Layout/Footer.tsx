      ...
      <div className="footer-content">
        <div className="footer-brand">
          ...
          <div className="social-icons-v2">
            <a href="https://t.me/diwanfinance" target="_blank" rel="noopener noreferrer" className="social-icon-link-v2" aria-label="Telegram">
            ...
            <a href="https://wa.me/message/AEE74AYQAKD6J1" target="_blank" rel="noopener noreferrer" className="social-icon-link-v2" aria-label="WhatsApp">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
